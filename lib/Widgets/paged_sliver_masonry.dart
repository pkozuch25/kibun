...
typedef SliverMasonryBuilder = SliverWithKeepAliveWidget Function(
  int childCount,
...
class PagedSliverMasonry<PageKeyType, ItemType> extends StatelessWidget {
  const PagedSliverMasonry({
  ...
  /// Matches [MasonryGridView.gridDelegate].
      ...
      PagedLayoutBuilder<PageKeyType, ItemType>(
        ...
        completedListingBuilder: (
          ...
          noMoreItemsIndicatorBuilder,
            ...
            _AppendedSliverGrid(
          sliverMasonryBuilder: (_, delegate) => SliverMasonryGrid(
            delegate: delegate,
...
class _AppendedSliverGrid extends StatelessWidget {
  const _AppendedSliverGrid({
    ...
    required this.sliverMasonryBuilder,
  ...
  final int itemCount;
  final SliverMasonryBuilder sliverMasonryBuilder;
